...
// if you use the '+' unary operator, the program is going to try to coerce the value to string which should result in something like:
//'deliciousafter workBowl' this result in a typeError because we are using an array method (join) on a string.